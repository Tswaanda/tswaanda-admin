...
type IdentficationDocProps = {
  setIDModal: (show: boolean) => void;
  openIDModal: boolean;
  showIdentificationDoc: (customer: any) => void;
  customer: any;
}

const IdentficationDoc: FC<IdentficationDocProps> = ({ setIDModal, openIDModal, showIdentificationDoc, customer }) => {
